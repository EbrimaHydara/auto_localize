...
const ServiceReplacementprogramSmsdifference: NextPage = () => {
  const pagetitle =
    '楽天モバイル買い替え超トクプログラム（正しい製品返却のお願い） '
  const directories = [
  ...
  return (
    <>
      <CustomHead
        ...
        description="楽天モバイル買い替え超トクプログラムサービスにて、お乗り換えもしくは解約されたお客様への、正しい製品返却のご案内ページになります。"
      />
      <SystemWrapper>
        <GlobalHeader />
        ...
        <SystemContainer className={Utils['Mt-32']}>
          <Heading level="1">
            【重要】正しい製品をご返却ください／楽天モバイル買い替え超トクプログラム
          </Heading>
        ...
        <SystemContainer className={Utils['Mt-32']}>
          <Heading level="2">
            本来返却すべき製品とは異なる製品がご返却されました。
            <br />
            すみやかにお乗り換え前の正しい製品、もしくはご解約された正しい製品をご返却ください。
          </Heading>
          <TxtCap as="p" className={Utils['Mt-8']}>
            ※メーカー修理された製品を返却された場合は、
            <LinkNormal href="/service/replacement-program/sms-warranty/?l-id=service_replacement-program_sms-difference_service_replacement-program_sms-warranty">
              こちら
            </LinkNormal>
            をご参照ください。
          </TxtCap>
        ...
        <SystemContainer className={Utils['Mt-64']}>
          <Heading level="2">製品返却時の流れ</Heading>
          <p className={Utils['Mt-16']}>
            下記の手順でご対応をお願いいたします。
          </p>
        ...
        <SystemContainer className={Utils['Mt-64']}>
          ...
          <ButtonRegular
            as="a"
            href="/service/replacement-program/?l-id=service_replacement-program_sms-difference_service_replacement-program"
...
export default ServiceReplacementprogramSmsdifference
