...
const SupportLinkMessage: NextPage = () => {
  const bigCategory = 'Rakuten Link'
  const smallCategory = 'メッセージサービス'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: 'https://service.link.link/guide/message/send_message.html',
      name: '新規メッセージを送る',
      ratid: 'support_link_guide_message_send_message',
      target: '_blank',
      isIconNewTabLine: true,
    },
    {
      path: 'https://service.link.link/guide/message/send_group_message.html',
      name: '新規グループメッセージを送る',
      ratid: 'support_link_guide_message_send_group_message',
      target: '_blank',
      isIconNewTabLine: true,
    },
    {
      path: 'https://service.link.link/guide/message/send_image.html',
      name: '画像・動画・ファイルを送る',
      ratid: 'support_link_guide_message_send_image',
      target: '_blank',
      isIconNewTabLine: true,
    },
  ]
  ...
  const youtubeContent: FaqMovieList[] = [
    {
      id: 'PCQCJ_gNhIo',
      title: 'メッセージサービスの使い方',
      description: '「Rakuten Link」アプリからメッセージを送信しよう',
      time: '2:39',
      isYoutube: true,
    },
  ]
...
export default SupportLinkMessage
