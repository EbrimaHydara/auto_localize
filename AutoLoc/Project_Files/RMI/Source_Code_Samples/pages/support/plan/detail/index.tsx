...
const SupportPlanDetail: NextPage = () => {
  const bigCategory = 'プラン・サービス'
  const smallCategory = 'プランの詳細'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/fee/un-limit/simulation/',
      name: '料金＆ポイントかんたんシミュレーション',
    },
    {
      path: '/guide/migration/',
      name: '楽天モバイルの料金プランを徹底比較',
    },
    {
      path: '/fee/un-limit/family/',
      name: '楽天モバイルなら家族みんなでおトクに使える',
      l_id: '?l-id=support_plan-detail_un-limit_family',
    },
    {
      path: '/guide/family/',
      name: '最強家族プログラムのご利用方法',
      l_id: '?l-id=support_category_guide',
    },
    {
      path: '/service/',
      name: 'オプションサービス',
