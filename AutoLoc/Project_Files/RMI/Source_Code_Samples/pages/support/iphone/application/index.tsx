...
const SupportIphoneApplication: NextPage = () => {
  ...
  const smallCategory = '申し込みからご利用開始まで'
  const titleCategory = '申し込みからお受け取りまで'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/iphone/',
      name: 'お手持ちのiPhoneを楽天モバイルで使う',
    },
    {
      path: '/guide/product/device-upgrade/',
      name: '楽天モバイルでの機種変更方法',
    },
  ]
  ...
  return (
    <>
      <CustomHead
        ...
        description={`${smallCategory}（iPhone・Apple Watch）に関する知りたい・調べたい情報をお選びください。`}
      />
      <SystemWrapper>
        <GlobalHeader />
