...
const SupportPricediscountPointgranted: NextPage = () => {
  const bigCategory = 'キャンペーン'
  const smallCategory = '適用条件・確認'
  ...
  const linkListContent: LinkListFaqItem[] = [
    ...
    {
      path: '/campaign/member/',
      name: 'ご契約中の方向けのキャンペーン・特典',
    },
    {
      path: '/campaign/close/',
      name: '過去のキャンペーン・特典',
...
export default SupportPricediscountPointgranted
