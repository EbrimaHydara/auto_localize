...
const SupportPricediscountDetail: NextPage = () => {
  const bigCategory = 'キャンペーン'
  const smallCategory = '詳細内容の確認'
  const titleCategory = `キャンペーンの${smallCategory}`
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/supporter-program/',
      name: '無料サポータープログラム アンケート・ポイントプレゼントについて',
    },
  ]
...
export default SupportPricediscountDetail
