...
const SupportApplicationCompatibledevice: NextPage = () => {
  const bigCategory = '申し込みからお受け取りまで'
  const smallCategory = '対応製品'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/iphone/',
      name: '楽天モバイル（楽天回線）でiPhoneを使う',
    },
    {
      path: '/product/compatible-band/',
      name: '取り扱い製品の他社回線対応状況一覧',
    },
  ]
...
export default SupportApplicationCompatibledevice
