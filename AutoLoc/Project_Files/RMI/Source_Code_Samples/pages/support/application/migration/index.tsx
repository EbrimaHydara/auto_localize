...
const SupportApplicationMigration: NextPage = () => {
  const bigCategory = '申し込みからお受け取りまで'
  const smallCategory = '楽天モバイル（ドコモ回線・au回線）からの移行'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/mnp/migration/',
      name: '楽天モバイル（楽天回線）への移行方法',
    },
    {
...
export default SupportApplicationMigration
