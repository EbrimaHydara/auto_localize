...
const SupportProductBig: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten BIG'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/smartphone/rakuten-big/support/',
      name: 'Rakuten BIGサポート情報',
    },
  ]
...
export default SupportProductBig
