...
const SupportProductBigs: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten BIG s'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/smartphone/rakuten-big-s/support/',
      name: 'Rakuten BIG sサポート情報',
    },
  ]
...
export default SupportProductBigs
