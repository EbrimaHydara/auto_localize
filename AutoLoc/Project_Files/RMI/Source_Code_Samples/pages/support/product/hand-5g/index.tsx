...
const SupportProductHand5g: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten Hand 5G'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/smartphone/rakuten-hand-5g/support/',
      name: 'Rakuten Hand 5Gサポート情報',
    },
  ]
...
export default SupportProductHand5g
