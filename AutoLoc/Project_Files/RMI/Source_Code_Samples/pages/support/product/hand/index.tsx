...
const SupportProductHand: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten Hand'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/smartphone/rakuten-hand/support/',
      name: 'Rakuten Handサポート情報',
    },
  ]
...
export default SupportProductHand
