...
const SupportProductCasa: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten Casa'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/area/rakuten-casa/guide/',
      name: 'Rakuten Casaご利用ガイド',
    },
    {
      path: '/guide/rakuten-casa/',
      name: 'Rakuten Casaアプリのご利用方法',
    },
    {
      path: '/area/rakuten-casa/broadband/',
      name: '指定インターネット回線一覧',
    },
    {
      path: '/guide/rakuten-casa/wps/',
      name: 'WPS機能のご利用方法（Rakuten Casa 6）',
    },
  ]
...
export default SupportProductCasa
