...
const SupportProductMini: NextPage = () => {
  const bigCategory = '製品（Android）'
  const smallCategory = 'Rakuten Mini'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/smartphone/rakuten-mini/support/',
      name: 'Rakuten Miniサポート情報',
    },
  ]
...
export default SupportProductMini
