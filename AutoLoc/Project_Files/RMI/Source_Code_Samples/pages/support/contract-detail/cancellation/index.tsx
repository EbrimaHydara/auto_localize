...
const SupportContractdetailCancellation: NextPage = () => {
  const bigCategory = '契約内容・お手続き'
  const smallCategory = '解約・MNP転出'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/contract-cancellation/',
      name: '初期契約解除について',
    },
    {
    ...
    {
      path: '/guide/cancellation_payment/',
      name: '解約後のご請求について',
    },
    {
      path: '/guide/cancellation/apple-watch-family-sharing/',
      name: 'Apple Watch ファミリー共有 解約方法',
    },
  ]
...
export default SupportContractdetailCancellation
