...
const SupportContractdetailSim: NextPage = () => {
  const bigCategory = '契約内容・お手続き'
  const smallCategory = 'SIMの交換・再発行'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/product/sim/',
      name: 'お使いのスマホそのままで楽天モバイルのSIMを使う方法',
    },
    {
...
export default SupportContractdetailSim
