...
const SupportPaymentBill: NextPage = () => {
  const bigCategory = '請求・お支払い方法'
  const smallCategory = '請求金額の確認'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/commission/',
      name: '各種手数料',
    },
    {
      path: '/guide/payment/flow/',
      name: '請求金額の確定とお支払い完了までの流れ',
    },
    {
      path: '/guide/payment/usage-details/',
      name: '利用明細と各種明細の確認方法',
    },
  ]
...
export default SupportPaymentBill
