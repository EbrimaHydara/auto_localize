...
const SupportPaymentGoogle: NextPage = () => {
  const bigCategory = '請求・お支払い方法'
  const smallCategory = '楽天モバイル キャリア決済'
  const titleCategory = '楽天モバイルキャリア決済'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/payment/google/',
      name: '楽天モバイルキャリア決済',
    },
    {
      path: '/guide/payment/google/google-setting/',
      name: '楽天キャリア決済 Google Playストアでの設定・ご利用方法',
    },
    {
      path: '/guide/payment/google/setting/',
      name: '楽天キャリア決済 ご利用情報の変更・利用履歴の確認方法',
    },
  ]
...
export default SupportPaymentGoogle
