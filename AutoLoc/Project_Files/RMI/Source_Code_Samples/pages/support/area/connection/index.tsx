...
const SupportAreaConnection: NextPage = () => {
  const bigCategory = 'エリア・データ通信・通話'
  const smallCategory = 'データ通信速度'
  ...
  const linkListContent: LinkListFaqItem[] = [
    {
      path: '/guide/area-speed/',
      name: 'サービスエリアの通信速度とデータ高速モードについて',
    },
    {
      path: '/guide/setting/5g/',
      name: '5G通信の設定方法',
    },
  ]
...
export default SupportAreaConnection
