  ...
  > li {
    ...
    & + li {
      ...
      &::before {
        ...
        width: 36px;
        height: 36px;
        background: url(${assets}img/campaign/tethering_todnndnt5d/icon-plus.png)
          no-repeat;
...
const CampaignForUser = styled.div`
  display: flex;
  gap: 24px;
  ${mixins.mq.MaxM} {
    gap: 16px;
...
const CampaignTetheringTodnndnt5d: NextPage = () => {
  const theme = useContext(ThemeContext)
  const pagetitle = 'エントリー＆テザリング利用で200ポイントプレゼント！'
  ...
  useEffect(() => {
    ...
    window.rexButtons = {language: 'ja', buttons: [{"code":"/rmobile/tethering200/240325","theme":"red","wide":true,"showCelebration":false,"alreadyAppliedText":"エントリー済みです","ids":["rex-ceb-01"]}]}
      `)
  ...
  return (
    <>
      ...
      <CustomHead
        ...
        description="エントリー＆テザリング利用で200ポイントプレゼント！キャンペーンの開始時点で楽天モバイル（Rakuten最強プラン）ご利用中の方が対象です"
        noindex={true}
        ogp_img="https://network.mobile.rakuten.co.jp/assets/img/campaign/tethering_todnndnt5d/ogp-200.png"
      />
      <SystemWrapper>
        <GlobalHeader />
          ...
          <h1>
            <picture>
              <source
                ...
                srcSet={`${assets}img/campaign/tethering_todnndnt5d/kv-sp.png`}
                width="834"
                height="734"
              />
              <img
                src={`${assets}img/campaign/tethering_todnndnt5d/kv-pc.png`}
                width="1440"
                height="300"
                alt="【本キャンペーンのご案内を受け取った方限定】エントリー＆テザリング利用で200ポイントプレゼント！"
              />
            </picture>
          </h1>
        </Kv>
        ...
        <SystemContainer>
          ...
          <p
            ...
            data-ratid="campaign_tethering-200_scroll-01_flow"
          ...
          <div className={`${Utils['Align-center']} ${Utils['Mt-48']}`}>
            ...
            <p className={Utils['Mt-16']}>
              ...
              <LinkNormal
                ...
                data-ratid="campaign_tethering-200_rule"
                data-ratevent="click"
                data-ratparam="all"
          ...
          <CampaignList className={Utils['Mt-40']}>
            <li>
              <CampaignListTtl>
                <div>
                  <img
                    src={`${assets}img/campaign/tethering_todnndnt5d/icon-campaign-01.png`}
                    alt=""
                    width="47"
                    height="47"
                    loading="lazy"
            ...
            <li>
              <CampaignListTtl>
                <div>
                  <img
                    src={`${assets}img/campaign/tethering_todnndnt5d/icon-campaign-02.png`}
                    alt=""
                    width="47"
                    height="47"
                    loading="lazy"
              ...
              <CampaignListBody>
                ...
                <LinkIconBeforeCustom
                  href="#tethering"
                  data-ratid="campaign_tethering-200_about"
                  data-ratevent="click"
                  data-ratparam="all"
                  onClick={(e: React.MouseEvent<HTMLElement, MouseEvent>) =>
          ...
          <PointWrap>
            ...
            <picture>
              <source
                media={`(max-width: ${theme.max.m})`}
                srcSet={`${assets}img/campaign/tethering_todnndnt5d/img-200point-sp.png`}
                width="802"
                height="374"
              />
              <img
                src={`${assets}img/campaign/tethering_todnndnt5d/img-200point-pc.png`}
                width="1032"
                height="160"
                alt="200ポイントプレゼント！"
                loading="lazy"
        ...
        <GrayBox className={`${Utils['Mt-40']} ${Utils['Mt-pc-56']}`}>
          <SystemContainer>
            <CustomHeading2
              ...
              data-ratid="campaign_tethering-200_scroll-02_about"
              data-ratevent="appear"
              data-ratparam="all"
            >
              <IconWifi
                src={`${assets}img/campaign/tethering_todnndnt5d/icon-wifi.png`}
                width="46"
                height="46"
                alt=""
              />
            ...
            <TetheringWrapText className={Utils['Mt-16']}>
              ...
              <img
                src={`${assets}img/campaign/tethering_todnndnt5d/img-01.png`}
                width="180"
                height="120"
                alt=""
                loading="lazy"
            ...
            >
              <InfoboxBorderCustom>
                <RecommendFlex>
                  ...
                  <div className={Utils['Align-center']}>
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/img-02.png`}
                      width="169"
                      height="114"
                      alt=""
                      loading="lazy"
              ...
              <InfoboxBorderCustom>
                <RecommendFlex>
                  ...
                  <div className={Utils['Align-center']}>
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/img-03.png`}
                      width="169"
                      height="114"
                      alt=""
                      loading="lazy"
            ...
            >
              <LinkIconAfter href="/service/tethering/?l-id=campaign_tethering_todnndnt5d_service_tethering">
                テザリングを詳しくみる
                <IconChevronRight />
              </LinkIconAfter>
            </div>
            <div className={Utils['Mt-48']}>
              <div className={Utils['Align-center']}>
                <Heading
                  level="3"
                  ratId="campaign_tethering-200_scroll-03_step"
                  ratEvent="appear"
                >
                  利用設定！簡単ステップ
                </Heading>
              ...
              >
                <StepFlowItem>
                  <div className="num">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-01.png`}
                      width="38"
                      height="50"
                      alt="STEP1"
                      loading="lazy"
                  ...
                  <div className="icon">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-01-02.png`}
                      width="64"
                      height="64"
                      alt=""
                      loading="lazy"
                ...
                <StepFlowItem>
                  <div className="num">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-02.png`}
                      width="38"
                      height="50"
                      alt="STEP1"
                      loading="lazy"
                  ...
                  <div className="icon">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-02-02.png`}
                      width="64"
                      height="64"
                      alt=""
                      loading="lazy"
                  ...
                  <ul className="text">
                    <li>
                      ...
                      <br className={Utils['Show-oox']} />
                      <LinkIconAfter
                        href="/guide/tethering/?l-id=campaign_tethering_todnndnt5d_guide_tethering#tab-menu1"
                    ...
                    <li className={Utils['Mt-8']}>
                      ...
                      <br className={Utils['Show-oox']} />
                      <LinkIconAfter
                        href="/guide/tethering/?l-id=campaign_tethering_todnndnt5d_guide_tethering#tab-menu2"
                        className={`${Utils['Ml-0']} ${Utils['Ml-pc-16']}`}
                      >
                        Androidの設定方法を詳しくみる
                        <IconChevronRight />
                ...
                <StepFlowItem>
                  <div className="num">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-03.png`}
                      width="38"
                      height="50"
                      alt="STEP1"
                      loading="lazy"
                  ...
                  <div className="icon">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-03-02.png`}
                      width="64"
                      height="64"
                      alt=""
                      loading="lazy"
                ...
                <StepFlowItem>
                  <div className="num">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-04.png`}
                      width="38"
                      height="50"
                      alt="STEP1"
                      loading="lazy"
                  ...
                  <div className="icon">
                    <img
                      src={`${assets}img/campaign/tethering_todnndnt5d/icon-step-flow-04-02.png`}
                      width="64"
                      height="64"
                      alt=""
                      loading="lazy"
...
export default CampaignTetheringTodnndnt5d
