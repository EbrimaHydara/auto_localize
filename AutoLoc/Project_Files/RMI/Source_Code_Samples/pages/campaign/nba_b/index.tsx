...
const CampaignNba: NextPage = () => {
  ...
  const anchorList = [
    {
      id: 'nba-pass-about',
      ratid: 'campaign_nba_anchor_about_B',
      text: 'NBA LEAGUE PASS for 楽天モバイルとは',
    },
    {
      id: 'use-steps',
      ratid: 'campaign_nba_anchor_flow_B',
      text: 'ご利用の流れ',
    },
    {
      id: 'about',
      ratid: 'campaign_nba_anchor_saikyo-plan_B',
      text: '楽天モバイルのご紹介',
    },
  ]
  // PITARI ABテストで使用
  useEffect(() => {
    ...
    phoenixTrackerScript.onload = () => {
      const $carouselIndicatorElems = RAT.$Selector('.carousel-indicators>*')
      // バインドの重複を防ぐため一旦リセットする
      $carouselIndicatorElems.off('click')
      // 要素の検知。最新ページャーの要素を取得する。※RAT飛ばすのにも必要
      RAT.bindClick($carouselIndicatorElems)
    }
  }, [])
  const pagetitle =
  ...
  const BnrRecommend = ({ lazy = true }: BnrRecommendProps) => {
    ...
    const recommendBnrs: BnrList = [
      {
        id: generateId(),
        url: 'https://tv.rakuten.co.jp/static/pacificleague/lp/mobile_cpn/?scid=wi_rmb_tv_mobile_cpn_B',
      ...
      {
        id: generateId(),
        url: 'https://magazine.rakuten.co.jp/cpn/mno/?scid=wi_rmb_magazine_cpn-mno_B',
      ...
      {
        id: generateId(),
        url: 'https://music.rakuten.co.jp/plan/bundle/?scid=wi_nba_rmb_mkdiv_mobile-nba_pc-sp_music-bundle_20240410_B',
      ...
      {
        id: generateId(),
        url: 'https://tv.rakuten.co.jp/static/mobile_cpn/lp/prairie-kids/?scid=wi_rmb_tv_prairie-kids_B',
      ...
      {
        id: generateId(),
        url: 'https://tv.rakuten.co.jp/static/mobile_cpn/lp/asiadrama-premium-channel/?scid=wi_rmb_tv_asiadrama-premium-channel_B',
      ...
      {
        id: generateId(),
        url: 'https://tv.rakuten.co.jp/static/mobile_cpn/lp/seiyuchannel/?scid=wi_rmb_tv_seiyuchannel_B',
      ...
      {
        id: generateId(),
        url: 'https://tv.rakuten.co.jp/static/mobile_cpn/lp/vcinema_monthlypack/?scid=wi_rmb_tv_vcinema_monthlypack_B',
      ...
      {
        id: generateId(),
        url: '/campaign/youtubepremium/?l-id=campaign_nba_campaign_youtubepremium_B',
    ...
    return (
      <div>
        ...
        <div className={`${Utils['Align-center']} ${Utils['Mt-24']}`}>
          <ButtonRegular
            as="a"
            href="/campaign/digital-contents/?l-id=campaign_nba_campaign_digital-contents_B"
          >
            楽天モバイルの特集ページを見る
          </ButtonRegular>
        </div>
  ...
  const CtaBottomFixed = ({ scrollTrigger }: CtaBottomFixedProps) => {
    ...
    return (
      <Container aria-expanded={isExpanded} ref={wrapperElem}>
        <Cta2col>
          <CvButtonPrimaryLarge lidR="campaign_nba_f_guide_application_03_B" />
          <CustomNbaBtn ratId="campaign_nba_application_03_B" />
        </Cta2col>
      </Container>
    )
  }
  ...
  const PopAsk = (props: PopAskProps) => {
    ...
    return (
      ...
      >
        ...
        <div
          id="js-npsRadio-0"
          data-ratid="npsRadio_1_B"
          data-ratevent="click"
          data-ratparam="all"
        ></div>
        <div
          id="js-npsRadio-1"
          data-ratid="npsRadio_2_B"
          data-ratevent="click"
          data-ratparam="all"
        ></div>
        <div
          id="js-npsRadio-2"
          data-ratid="npsRadio_3_B"
          data-ratevent="click"
          data-ratparam="all"
        ></div>
        <div
          id="js-npsRadio-3"
          data-ratid="npsRadio_4_B"
          data-ratevent="click"
          data-ratparam="all"
        ></div>
        <div
          id="js-npsRadio-4"
          data-ratid="npsRadio_5_B"
          data-ratevent="click"
          data-ratparam="all"
        ></div>
      </SystemContainer>
  ...
  return (
    <>
      <CustomHead
        ...
        canonical_custom="https://network.mobile.rakuten.co.jp/campaign/nba/"
      />
      <SystemWrapper>
        <GlobalHeader />
          ...
          <h1>
            <picture>
              <source
                ...
                srcSet={`${assets}img/campaign/nba/kv-sp-240422.png`}
                width="100%"
              />
              <img
                src={`${assets}img/campaign/nba/kv-pc-240422.png`}
                width="1429"
                height="300"
                alt="おトクに楽しみたい方：Rakuten最強プラン（税込1,078円/月〜）ご契約でNBA全試合0円で見放題！ 楽天モバイルのご契約なしで楽しみたい方はLEAGUE PASS（税込4,500円/月）"
              />
            </picture>
          </h1>
        </KvHeading>
        ...
        <SystemContainer>
          <TxtCap as="p" className={Utils['Mt-16']}>
            ...
            <br />
            <TxtEmp02>
              ※「Rakuten最強プラン」プラン開始直後に本サービスを利用する場合、サービス適用条件を満たすまで3日から4日程度お待ちいただく場合がございます。
            </TxtEmp02>
            <br />
            ※本サービスは予告なく内容の変更、中止もしくは延長させていただく場合があります。あらかじめご了承ください。
          </TxtCap>
          <Cta2col className={Utils['Mt-16']}>
            <CvButtonPrimaryLarge lidR="campaign_nba_f_guide_application_01_B" />
            <CustomNbaBtn ratId="campaign_nba_application_01_B"></CustomNbaBtn>
          </Cta2col>
          <AnchorListCustom
        ...
        <CustomBoxApp>
          <MangaTitleContainer>
            <CustomTxtSize
              ...
              data-ratid="campaign_nba_scroll-01_comic_B"
          ...
          <CarouselContainer>
            <CustomKvCarousel
              ...
              prevRatId="campaign_nba_carousel_left_B"
              nextRatId="campaign_nba_carousel_right_B"
              indicatorRatIdPrefix="campaign_nba_"
              indicatorRatIdSuffix="_B"
              noUrl={true}
          ...
          <CustomTxtCap className={Utils['Mt-8']}>
            ...
            <li>
              ※1 詳細は
              <LinkNormal href="https://network.mobile.rakuten.co.jp/guide/procedure/?l-id=campaign_nba_guide_procedure_B">
                こちら
              </LinkNormal>
            </li>
          </CustomTxtCap>
        ...
        <SystemContainer>
          ...
          <Heading
            ...
            ratId="campaign_nba_scroll-02_about_B"
            ratEvent="appear"
            id="nba-pass-about"
          >
          ...
          <Heading
            level="2"
            className={`${Utils['Align-center']} ${Utils['Mt-48']}`}
            ratId="campaign_nba_scroll-03_flow_B"
            ratEvent="appear"
            id="use-steps"
          >
          ...
          <Tab
            ...
            id1="tab1"
            id2="tab2"
            ratId1="campaign_nba_flow_tab_pre-member_B"
            ratId2="campaign_nba_flow_tab_member_B"
            content1={
              <>
                <AccordionListEmp
                  text={
                  ...
                  className={Utils['Mt-24']}
                  step={true}
                  ratid="campaign_nba_flow_step1_B"
                >
                  <MediaGrid>
                    <MediaImage>
                      <img
                  ...
                  <div className={`${Utils['Align-center']} ${Utils['Mt-24']}`}>
                    <CvButtonPrimaryLarge lidR="campaign_nba_f_guide_application_02_B" />
                  </div>
                </AccordionListEmp>
                ...
                <AccordionListEmp
                  ...
                  className={Utils['Mt-24']}
                  step={true}
                  ratid="campaign_nba_flow_step2_B"
                >
                  <MediaGridCustom>
                    <MediaImage>
                      <img
                ...
                <AccordionListEmp
                  ...
                  className={Utils['Mt-24']}
                  step={true}
                  ratid="campaign_nba_flow_step3_B"
                >
                  ...
                  <div className={`${Utils['Align-center']} ${Utils['Mt-24']}`}>
                    <ButtonSecondaryLarge
                      as="a"
                      href="https://nba.rakuten.co.jp/?scid=wi_20231020_nbar_top_rmi&utm_source=nbar_top&utm_medium=rmi&utm_campaign=lp_guide_B"
                      target="_blank"
                      data-ratid="campaign_nba_application_02_B"
                      data-ratevent="click"
                      data-ratparam="all"
                    >
                      NBA Rakutenを見る
            ...
            content2={
              <>
                <AccordionListEmp
                  ...
                  className={Utils['Mt-24']}
                  step={true}
                  ratid="campaign_nba_flow_member_step1_B"
                >
                  <Heading level="4" className={Utils['Align-center']}>
                    <TxtEmp02>
                      楽天モバイルをご契約の楽天IDでNBA
                  ...
                  <div className={`${Utils['Align-center']} ${Utils['Mt-24']}`}>
                    <ButtonSecondaryLarge
                      ...
                      href="https://nba.rakuten.co.jp/?scid=wi_20231020_nbar_top_rmi&utm_source=nbar_top&utm_medium=rmi&utm_campaign=lp_guide_B"
                      target="_blank"
                      data-ratid="campaign_nba_application_02_member_B"
                      data-ratevent="click"
                      data-ratparam="all"
                    >
                      NBA Rakutenを見る
          ...
          <Heading
            level="2"
            className={`${Utils['Align-center']} ${Utils['Mt-48']}`}
            ratId="campaign_nba_scroll-04_how-to-watch_B"
            ratEvent="appear"
          >
            試合を観る方法
          </Heading>
          ...
          <UserVoiceLinkWrap className={Utils['Mt-48']}>
            ...
            <UserVoiceLinkItem className={Utils['Mt-16']}>
              ...
              <div>
                ...
                <LinkIconAfter href="/uservoice/64/?l-id=campaign_nba_uservoice_64_B">
                  続きを読む
                  <IconChevronRight />
                </LinkIconAfter>
              </div>
        ...
        <SystemContainer>
          <Heading
            level="2"
            className={`${Utils['Align-center']} ${Utils['Mt-48']}`}
            ratId="campaign_nba_scroll-05_faq_B"
            ratEvent="appear"
          >
            よくあるご質問
          </Heading>
          ...
          <Heading
            level="2"
            className={`${Utils['Align-center']} ${Utils['Mt-48']}`}
            ratId="campaign_nba_scroll-06_saikyo-plan_B"
            ratEvent="appear"
            id="about"
          >
            楽天モバイルのご紹介
          ...
          <div className={Utils['Mt-24']}>
            <CommonSaikyo lid={`campaign_nba_fee_saikyo-plan_B`} />
          </div>

          <Heading
            level="2"
            className={`${Utils['Align-center']} ${Utils['Mt-48']}`}
            ratId="campaign_nba_scroll-07_campaign_B"
            ratEvent="appear"
          >
          ...
          <div className={`${Utils['Mt-24']} ${Utils['Align-center']}`}>
            <BannerHover href="/tips/gservice/?l-id=campaign_nba_tips_gservice_B">
              <img
