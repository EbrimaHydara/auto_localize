<template>
<div id="js-result">
    <div class="service-tradein-Layout_Resultwrap">
        <div class="u-Adjust_Align-center u-Adjust_Mt-32 c-Txt_Emp-02">
            <p class="c-Txt_Normal-s">{{ selectedCarrier }}</p>
            <p>{{ selectedMaker }} {{ selectedDevice }} {{ selectedMemory }}</p>
        </div>
        <div class="c-Table_Wrap u-Adjust_Mt-24">
            <table class="c-Table_Container service-tradein-Layout_Table-pc">
                <tr>
                    <th>製品状態</th>
                    <td>良品</td>
                    <td>画面損傷品</td>
                ...
                <tr v-for="(price, index) in priceList" :key="index">
                    ...
                    <button class="c-Tooltip js-Tooltip-inline" data-tippy-theme="default" data-tippy-content="楽天ペイなど、楽天のたくさんのサービスでご利用可能なオンライン電子マネーです。">
            ...
            <table class="c-Table_Container service-tradein-Layout_Table-sp">
                <thead>
                    <tr>
                        <th>製品状態</th>
                        <th>
        ...
        <p class="c-Txt_Cap u-Adjust_Mt-8">
            ...
            ※ 表示価格は税込です。<br>
            ※ <a href="https://cash.rakuten.co.jp/overview/" rel="noopener" target="_blank" class="c-Link_Txt-inline-icon">楽天キャッシュの詳細はこちら<span class="c-Icon_New-window-l"></span></a>をご覧ください。<br>
            ※価格が「-」と表示されるものは下取り対象外となります。
        </p>

        <div class="u-Adjust_Mt-32 u-Adjust_Align-center">
            <a href="https://r10.to/hM569V" class="c-Btn_Primary-large" data-ratId="tradein_apply_simlulation" data-ratEvent="click" data-ratParam="all"><span>下取りのお申し込みに進む</span></a>
            <a href="#" class="c-Btn_Regular u-Adjust_Mt-16" data-ratId="tradein_otherproduct" data-ratEvent="click" data-ratParam="all" @click.prevent="priceReset()"><span>別の製品を確認する</span></a>
        </div>
    </div>
</div>
</template>
