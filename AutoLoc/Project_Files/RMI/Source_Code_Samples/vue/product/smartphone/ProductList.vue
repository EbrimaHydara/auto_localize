<template>
    <div>
        <template v-if="state.sorter === 'recommend' && state.filters === 'all'">
            <p class="u-Adjust_Mt-24">プレミアム スタイル</p>
            <h2 class="c-Heading_Lv3 u-Adjust_Mt-8">心を満たすクオリティー</h2>
            ...
            <p class="u-Adjust_Mt-48">ニュースタンダード</p>
            <h2 class="c-Heading_Lv3 u-Adjust_Mt-8">挑戦的で新しい</h2>
            ...
            <p class="u-Adjust_Mt-48">コンフォートスタイル</p>
            <h2 class="c-Heading_Lv3 u-Adjust_Mt-8">手放せない使いやすさ</h2>
