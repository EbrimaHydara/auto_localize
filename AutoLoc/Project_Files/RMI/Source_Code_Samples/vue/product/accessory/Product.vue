<template>
  <li class="c-Card_Normal">
    ...
    <div class="accessory-top-Card_Price">
      ...
      <p v-else-if="summary.product !== 'Rakuten Mini ガラスフィルム 高光沢'"><span v-if="summary.price_old"><span class="c-Txt_Alphanumeric-m accessory-top-Card_Price-borderdouble">{{ summary.price_old | addComma }}</span>円→</span><span class="c-Txt_Alphanumeric-m">{{ summary.price | addComma }}</span>円</p>
