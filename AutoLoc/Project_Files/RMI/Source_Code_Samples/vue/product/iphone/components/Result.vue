...
<div id="js-result">
    <div class="product-iphone-Tradein_Resultwrap">
        ...
        <div class="u-Adjust_Mt-32 u-Adjust_Align-center">
            <a v-bind:href="'/service/tradein/?l-id=product_' + deviceName + '_apply_service_tradein'" class="c-Btn_Primary-large"><span>下取りのお申し込みに進む</span></a>
            <a href="#" class="c-Btn_Regular u-Adjust_Mt-16" @click.prevent="priceReset()"><span>他製品の下取り価格を確認する</span></a>
        </div>
