<template>
    <div>
        <div v-show="filtered.length > 0" class="area-city-Shop_List-wrap">
        <div class="area-city-Shop_List-wrap-inner" id="js-result-top">

            <ul class="area-city-Shop_List">
...
export default {
    ...
    props: ['shops', 'pref', 'city', 'directory1', 'directory2'],
    data () {
        return {
            perPage: 4
        }
    ...
    mounted () {
        mutations.setPrefecture(this.pref);
        mutations.setCity(this.city);
    },
    computed: {
        filtered () {
