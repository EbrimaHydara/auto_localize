...
export default {
  ...
  created() {
    const date = device_top.sort((a ,b) => a.priority - b.priority);
        ...
        responsive: [
            ...
            },
            {
                ...
                settings: {
                    ...
                    appendArrows: topCarouselProductSmartphone.next('.c-Carousel_Nav-v2-wrap').children('.c-Carousel_Nav-v2'),
                    appendDots: topCarouselProductSmartphone.next('.c-Carousel_Nav-v2-wrap').children('.c-Carousel_Nav-v2'),
                }
            }
        ]
    }));
