    ...
    <DescriptionListDefault className={Utils['Mt-8']}>
      ...
      <div>
        ...
        <dd>
          ...
          <TxtEmp02 as="p">
            ABEMAプレミアムへの会員登録をお申し込みいただいたお客様が対象となります
          </TxtEmp02>
          <CpnListMark1>
            <li>
              本キャンペーン専用の申込ページよりABEMAプレミアムにお申し込みください
            </li>
            <li>
              my
              楽天モバイルの連絡先メールアドレスと同じメールアドレスをABEMAプレミアムの会員登録時にご使用ください
            </li>
          </CpnListMark1>
      ...
      <div>
        ...
        <dd>
          ...
          <TxtEmp01 as="p" className={Utils['Mt-8']}>
            毎月のABEMAプレミアム利用に応じて最大3カ月間、月額利用料の20%にあたる174ポイントを毎月還元
            <br />
      ...
      <div>
        ...
        <dd>
          ...
          <CpnListMark1>
            <li>
              当社の提供するサービス、ABEMAなどの料金のお支払いが、お支払い期限までに行われず、未納・未払いが発生した場合
            </li>
            <li>ABEMAプレミアムへの加入が確認できない場合</li>
            <li>
              「楽天モバイル
              エンタメ祭キャンペーン」を経由したABEMAへのお申し込み回数が、おひとり様1契約1回を超える場合は対象外となります
            </li>
            <li>
            ...
            <li>
              my
              楽天モバイルの連絡先メールアドレスとABEMAプレミアム会員情報（メールアドレス）が一致しない場合
            </li>
            <li>
              本キャンペーン専用の申込ページ以外からABEMAプレミアムに申し込んだ場合
            </li>
            <li>
            ...
            <li>
              ポイント付与までにキャンペーンエントリー時点のABEMAプレミアム会員情報（メールアドレス）を変更した場合
            </li>
            <li>
      ...
      <div>
        ...
        <dd>
          <CpnListMark1>
            ...
            <li>
              本キャンペーンの運営に関連して取得した応募者の個人情報は、応募条件を満たしていることの確認およびポイント付与を目的として株式会社
              AbemaTVに取扱いを委託いたします。
            </li>
            <li>
