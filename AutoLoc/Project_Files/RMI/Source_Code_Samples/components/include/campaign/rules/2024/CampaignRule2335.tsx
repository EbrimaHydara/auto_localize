...
export const CampaignRule2335: React.FC<Props> = ({ className }) => {
  return (
    <DescriptionListDefault className={className}>
      ...
      <div>
        ...
        <dd>
          <div>
            ...
            Web　2024年5月2日（木）18:00～終了日未定
            <br />
            店舗（楽天モバイルショップ）　2024年5月2日（木）18:00～終了日未定
          </div>
        </dd>
      </div>
      <div>
          ...
          <div>
            ...
            <div className={Utils['Mt-16']}>
              ...
              <CpnListMark1>
                <li>
                  <TxtEmp01>
                    2024年5月2日の「最強こどもプログラム」開始前までに「最強青春プログラム」にエントリー済みの方は、本エントリーは不要です。エントリー情報を引き継ぎいたします
                  </TxtEmp01>
                </li>
                <li>
                  「Rakuten最強プラン」を利用されている＜12歳以下のお客様ご自身＞の楽天IDでのエントリーが必要です
                </li>
                <li>
            ...
            <div className={Utils['Mt-16']}>
              <CpnTitlelv1 as="p">
                <span>【3】</span>12歳以下のお客様
              </CpnTitlelv1>
              13歳の誕生月前月までが対象となります
              <br />
              例）5/15で13歳になる場合、5月はポイント付与の対象外
              <CpnListMark1>
                <li>
                  本プログラムにエントリー済みの方は、13歳になる月から自動的に「最強青春プログラム」の対象になります。改めてのエントリーは不要です
                </li>
              </CpnListMark1>
            </div>
          </div>
      ...
      <div>
        ...
        <dd>
          <div>
            ...
            <TxtEmp01 as="p">
              <span>毎月 最大440ポイント還元</span>
            </TxtEmp01>
            <TxtEmp01>
              (a)当月利用量が３GB以下：440ポイント還元
              <br />
              (b)当月利用量が３GBを超過：110ポイント還元　
            </TxtEmp01>
            <CpnListMark1>
              <li>
                エントリーした楽天IDに紐づく回線が複数あり、(a)(b)それぞれを満たす回線がある場合は、440ポイントの還元となります
              </li>
              <li>
          ...
          <div className={Utils['Mt-16']}>
            ...
            <CpnListMark1>
              <li>
                例）5月にすべての条件を達成した場合には、その翌々月である7月末日ごろにポイント付与となります
              </li>
      ...
      <div>
        ...
        <dd>
          <TxtEmp01>
            以下のキャンペーンは <TxtEmp02>併用不可</TxtEmp02>
            となります。以下記載のキャンペーン以外は併用可能となります
          </TxtEmp01>
          <CpnListMark2Normal>
            <li>最強青春プログラム（2265）</li>
          </CpnListMark2Normal>
          <CpnListMark1>
            <li>
              最強青春プログラムと本プログラムを申し込みした場合、12歳以下のお客様は本プログラムが適用され、最強青春プログラムは対象外となります
            </li>
          </CpnListMark1>
        </dd>
      </div>
