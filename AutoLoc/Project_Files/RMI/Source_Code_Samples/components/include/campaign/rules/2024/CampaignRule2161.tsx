    ...
    <DescriptionListDefault className={Utils['Mt-8']}>
      ...
      <div>
        ...
        <dd>
          ...
          <p>Huluへの会員登録をお申し込みいただいたお客様が対象となります</p>
          <CpnListMark1 className={Utils['Mt-8']}>
            <li>本キャンペーン専用の申込ページよりHuluにお申し込みください</li>
            <li>
              my
              楽天モバイルの連絡先メールアドレスと同じメールアドレスをHuluの会員登録時にご使用ください
            </li>
          </CpnListMark1>
      ...
      <div>
        ...
        <dd>
          ...
          <TxtEmp01 as="p" className={Utils['Mt-8']}>
            毎月のHulu利用に応じて最大6カ月間、月額利用料の20%にあたる186ポイントを毎月還元
            <br />
      ...
      <div>
        ...
        <dd>
          ...
          <CpnListMark1>
            <li>
              当社の提供するサービス、Huluなどの料金のお支払いが、お支払い期限までに行われず、未納・未払いが発生した場合
            </li>
            <li>Huluへの加入が確認できない場合</li>
            <li>
              「楽天モバイル
              エンタメ祭キャンペーン」を経由したHuluへのお申し込み回数が、おひとり様1契約1回を超える場合は対象外となります
            </li>
            <li>
            ...
            <li>
              my
              楽天モバイルの連絡先メールアドレスとHulu会員情報（メールアドレス）が一致しない場合
            </li>
            <li>本キャンペーン専用の申込ページ以外からHuluに申し込んだ場合</li>
            <li>
              ポイント付与までにキャンペーンエントリー時点のmy
              楽天モバイルの連絡先メールアドレスを変更した場合
            </li>
            <li>
              ポイント付与までにキャンペーンエントリー時点のHulu会員情報（メールアドレス）を変更した場合
            </li>
            <li>
      ...
      <div>
        ...
        <dd>
          <CpnListMark1>
            ...
            <li>
              本キャンペーンの運営に関連して取得した応募者の個人情報は、応募条件を満たしていることの確認およびポイント付与を目的としてHJホールディングス株式会社に取扱いを委託いたします。
            </li>
            <li>
