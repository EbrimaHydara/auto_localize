    ...
    <DescriptionListDefault className={Utils['Mt-8']}>
      ...
      <div>
        ...
        <dd>
          ...
          <TxtEmp02 as="p">
            DMMプレミアムへの登録を新規にお申し込みいただいたお客様、または過去にDMMプレミアムを退会され再度お申し込み頂いたお客様が対象となります
          </TxtEmp02>
          <CpnListMark1>
            <li>
              <TxtEmp02>
                DMMプレミアム30日間無料トライアルの適用条件については
                <LinkNormal
                  href="#free-trial"
                  onClick={e => anchorCallback(e, 'free-trial')}
                >
                  以下
                </LinkNormal>
                をご確認ください
            ...
            <li>
              本キャンペーン専用の申込ページよりDMMプレミアムにお申し込みください
            </li>
            <li>
              my
              楽天モバイルの連絡先メールアドレスと同じメールアドレスをDMMプレミアムの会員登録時にご使用ください
            </li>
          </CpnListMark1>
      ...
      <div>
        ...
        <dd>
          ...
          <TxtEmp01 as="p" className={Utils['Mt-8']}>
            毎月のDMMプレミアム利用に応じて最大6カ月間、月額利用料の20%にあたる100ポイントを毎月還元
          </TxtEmp01>
          <CpnListMark1>
            <li>
              ただし、無料期間中のご利用についてはポイント還元対象外となります
            </li>
            <li>
              DMMプレミアム30日間無料トライアル期間終了日の翌日から月額料金が発生します。以降は毎月自動継続となります。
            </li>
            <li>DMMの視聴プランページより有効期限をご確認ください</li>
            <li>
              DMMプレミアム30日間無料トライアルの適用条件については
              <LinkNormal href="#free-trial">以下</LinkNormal>をご確認ください
            </li>
          </CpnListMark1>
          <TxtEmp01 as="p" className={Utils['Mt-16']}>
            ■ ポイント付与日
      ...
      <div>
        ...
        <TxtEmp02 as="dd">
          <p>下記の条件をすべて満たした場合に無料体験が適用されます。</p>
          <p>初めてDMMプレミアムに登録した方</p>
          <p>お支払い方法に下記いずれかを選択</p>
          <CpnListMark2>
            <li>クレジットカード</li>
            <li>キャリア決済</li>
            <li>Amazon app内課金</li>
          ...
          <CpnListMark1>
            <li>以下の場合はDMMプレミアム 無料トライアルは適用されません</li>
          </CpnListMark1>
          <CpnListOrderedLv2>
            <li>過去にDMMプレミアムに登録され、退会済みの場合</li>
            <li>ご登録時のお支払いにDMMポイントを選択された場合</li>
            <li>
              同じクレジットカードで過去にDMMプレミアムに登録したことがある場合
            </li>
            <li>
              同じキャリア決済アカウントで過去にDMMプレミアムに登録したことがある場合
            </li>
            <li>
              同じAmazonアカウントで過去にDMMプレミアムに登録したことがある場合
            </li>
            <li>その他、弊社が無料体験の対象外と判断した場合</li>
          </CpnListOrderedLv2>
        </TxtEmp02>
      </div>
      <div>
        ...
        <dd>
          ...
          <CpnListMark1>
            <li>
              当社の提供するサービス、DMMプレミアムなどの料金のお支払いが、お支払い期限までに行われず、未納・未払いが発生した場合
            </li>
            <li>DMMプレミアムへの加入が確認できない場合</li>
            <li>キャンペーンエントリー時点でDMMプレミアムに加入済みの場合</li>
            <li>
              「楽天モバイル
              エンタメ祭キャンペーン」を経由したDMMプレミアムへのお申し込み回数が、おひとり様1契約1回を超える場合は対象外となります
            </li>
            <li>
              ご契約者
            ...
            <li>
              my
              楽天モバイルの連絡先メールアドレスとDMMプレミアム会員情報（メールアドレス）が一致しない場合
            </li>
            <li>
              本キャンペーン専用の申込ページ以外からDMMプレミアムに申し込んだ場合
            </li>
            <li>
            ...
            <li>
              ポイント付与までにキャンペーンエントリー時点のDMMプレミアム会員情報（メールアドレス）を変更した場合
            </li>
            <li>
              ポイント付与までにキャンペーンエントリー時点の楽天モバイルに連携している楽天IDを変更した場合
            </li>
            <li>ポイント付与までに楽天会員から退会している場合</li>
            <li>
      ...
      <div>
        ...
        <dd>
          <CpnListMark1>
            ...
            <li>
              本キャンペーンの運営に関連して取得した応募者の個人情報は、応募条件を満たしていることの確認およびポイント付与を目的として合同会社
              DMM.comに取扱いを委託いたします。
            </li>
            <li>
              本キャンペーンへ申込みをされた方の個人情報は、応募条件確認・キャンペーン特典付与等の目的のために合同会社DMM.comに提供されます。
            </li>
            <li>
              合同会社DMM.comは、上記個人情報と自ら取得する個人情報を突合させた結果の個人情報を上記目的のために楽天グループ株式会社に提供します。
            </li>
            <li>
