        ...
        if (redirect) {
          ...
          return (
            <Head>
              ...
              <meta name="author" content="楽天ひかり" />
              <meta
                name="robots"
                content="noindex, nofollow, noarchive"
                key="robots"
              ...
              <meta
                ...
                content={
                  ogp_img
                    ? ogp_img
                    : `${sitedomain}/assets/img/hikari/top/ogp-top-230412.png`
                }
              />
              <link rel="shortcut icon" href="/google-search-icon-hikari.png" />
              <link
                rel="apple-touch-icon"
                href="/apple-touch-icon-hikari.png"
              />
