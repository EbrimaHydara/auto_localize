...
const SEARCH_SERVER_URL =
  // 'https://gateway-api.global.rakuten.com/bot/deepqa-v2-stg-for-integration/v2/mno-whole-site/query'
  'https://gateway-api.global.rakuten.com/bot/deepqa-knowledge-discovery/v2/mno-whole-site/query'
...
export type SendAnalysisProps = {
  ...
  data: {
    ...
    referrer?: string
    smart_input_items?: ApiResult['quick_links']
    campaign_items?: ApiResult['recommend_contents']
    product_items?: ApiResult['items']
  }
  session_id: string
  ua: string
}
export type FaqSolved = { name: string; solved: number }[]
...
const actions = {
  ...
  faqSolvedApi(setStateAction: Dispatch<SetStateAction<FaqSolved>>) {
    axios
      .get('/api/faq_solved')
      .then(v => setStateAction(v.data.list))
