    ...
    $choices.on('change', function() {
        ...
        $selected.each(function() {
            if ($(this).val() === 'フレッツ光を利用していない') {
                ...
                resultInitialValue = '<span class="c-Txt_Normal-l c-Txt_Emp">800</span><span class="hikari-fee-Txt_Sub"> 円（税込 880 円）／初月のみ</span>';
            }
            if ($(this).val() === 'フレッツ光を利用している') {
                notUsingFletsHikari = false;
                usingFletsHikari = true;
                otherCompanyHikari = false;
                resultInitialValue = '<span class="c-Txt_Normal-l c-Txt_Emp">1,800</span><span class="hikari-fee-Txt_Sub"> 円（税込 1,980 円）／初月のみ</span>';
            }
