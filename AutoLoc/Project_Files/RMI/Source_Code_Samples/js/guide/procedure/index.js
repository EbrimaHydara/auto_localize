...
const step2Itema = Array.from(document.getElementsByClassName('procedure-Step1_Item'));
for(let item of step2Itema) {
  item.addEventListener('click', (e) => {
    ...
    const activeContent = document.querySelector('.procedure-Step1_Content[aria-expanded="true"]');
