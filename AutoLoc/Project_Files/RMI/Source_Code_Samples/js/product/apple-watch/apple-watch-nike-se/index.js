...
const namespace = 'product-apple-watch-nike-se';
...
const CasetypeToBandTable = {
    'スペースグレイアルミニウム': ['アンスラサイト/ブラックNikeスポーツバンド'],
    'シルバーアルミニウム': ['ピュアプラチナム/ブラックNikeスポーツバンド'],
};
...
const switchCtaUrl = (caseSize, caseType, band, position) => {
    ...
    // const l_id = position === 'top' ? '&l-id=apple-watch-nike-se_top_bss-apple-watch-nike-se' : '&l-id=apple-watch-nike-se_bottom_bss-apple-watch-nike-se';
    const genId = `${caseSize}mm${caseType}ケースと${band}`;
    let result = '';
    switch (genId) {
        case '40mmスペースグレイアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド'://1
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600265';
        break;
        case '40mmシルバーアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド'://2
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600266';
        break;
        case '44mmスペースグレイアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド'://3
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600267';
        break;
        case '44mmシルバーアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド'://4
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600268';
        break;
        default:
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600265';
    }
