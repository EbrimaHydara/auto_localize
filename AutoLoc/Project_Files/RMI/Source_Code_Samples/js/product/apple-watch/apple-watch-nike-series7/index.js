...
const namespace = 'product-apple-watch-nike-series7';
...
const CasetypeToBandTable = {
    'ミッドナイトアルミニウム': ['アンスラサイト/ブラックNikeスポーツバンド'],
    'スターライトアルミニウム': ['ピュアプラチナム/ブラックNikeスポーツバンド'],
};
...
const switchCtaUrl = (caseSize, caseType, band, position) => {
    ...
    // const l_id = position === 'top' ? '&l-id=apple-watch-nike-series7_top_bss-apple-watch-nike-series7' : '&l-id=apple-watch-nike-series7_bottom_bss-apple-watch-nike-series7';
    const genId = `${caseSize}mm${caseType}ケースと${band}`;
    let result = '';
    /* original strings
    41mmスターライトアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド
    41mmミッドナイトアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド
    45mmスターライトアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド
    45mmミッドナイトアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド

    original URLs
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600255
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600256
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600257
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600258
    */
    switch (genId) {
        case '41mmスターライトアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド'://1
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600255';
        break;
        case '41mmミッドナイトアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド'://2
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600256';
        break;
        case '45mmスターライトアルミニウムケースとピュアプラチナム/ブラックNikeスポーツバンド'://3
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600257';
        break;
        case '45mmミッドナイトアルミニウムケースとアンスラサイト/ブラックNikeスポーツバンド'://4
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600258';
        break;
        default:
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600256';
    }
