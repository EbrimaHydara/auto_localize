...
const namespace = 'product-apple-watch-se';
...
let currentCasetype = 'スペースグレイアルミニウム';
let currentCasetypeSimu = 'スペースグレイアルミニウム';
const CasetypeToBandTable = {
    'スペースグレイアルミニウム': ['ミッドナイトスポーツバンド'],
    'シルバーアルミニウム': ['アビスブルースポーツバンド'],
    'ゴールドアルミニウム': ['スターライトスポーツバンド'],
};
...
const switchCtaUrl = (caseSize, caseType, band, position) => {
    ...
    original URLs
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600259
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600260
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600261
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600262
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600263
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600264
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600281
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600282
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600283
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600284
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600285
    https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600286
    */
    switch (genId) {
        case '40mmシルバーアルミニウムケースとアビスブルースポーツバンド'://1
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600259';
        break;
        case '40mmゴールドアルミニウムケースとスターライトスポーツバンド'://2
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600260';
        break;
        case '40mmスペースグレイアルミニウムケースとミッドナイトスポーツバンド'://3
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600261';
        break;
        case '44mmシルバーアルミニウムケースとアビスブルースポーツバンド'://4
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600262';
        break;
        case '44mmゴールドアルミニウムケースとスターライトスポーツバンド'://5
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600263';
        break;
        case '44mmスペースグレイアルミニウムケースとミッドナイトスポーツバンド'://6
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600264';
        break;
        default:
        result = 'https://onboarding.mobile.rakuten.co.jp/equipment-details?exid=600261';
    }
