const carouselConfig = {
  ...
  const searchLid= document.getElementById('js-shop-Search_Select-Lid');
//   const sitepath = '/';
...
$.getJSON('https://network.mobile.rakuten.co.jp/shopmaster-public/v1/shops')
    ...
    function enableSearchByPrefCity() {
        if (searchByPrefCity) {
            let url = sitepath + 'shop/search/?prefecture=' + encodeURI(selectPref.value) + '&city=' + selectCity.value + '&l-id=' + searchLid.value;
            if (selectPref.value !== '') {
